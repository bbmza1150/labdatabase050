...
wrRoute.post('/users',function(req,res,next){
    ...
    connection.execute(`INSERT INTO User_tbl (name, tel, username, password, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?);`,
...
wrRoute.post('/check', function (req, res, next) {
    ...
    connection.execute('SELECT * FROM User_tbl WHERE username=? AND password=?;',
